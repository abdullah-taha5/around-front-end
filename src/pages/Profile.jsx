...
function Profile({ userData }) {
  ...
  const profilePhotoUploadUser = async () => {
    ...
    await axios.post(
      "https://blue-violet-kingfisher-gear.cyclic.app/api/users/profile/profile-photo-upload",
      formNewProfilePhoto,
      {
        headers: {
  ...
  const profilePhotoUploadDriver = async () => {
    ...
    formNewProfilePhoto.append("image", profilePhoto);
    await axios.post(
      "https://blue-violet-kingfisher-gear.cyclic.app/api/driver/profile/profile-photo-upload",
      formNewProfilePhoto,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  const saveNewProfileInfoDriver = async (e) => {
    ...
    if (password) {
      await axios.put(
        `https://blue-violet-kingfisher-gear.cyclic.app/api/driver/profile/${userData.id}`,
        { username, password },
        {
          headers: {
            Authorization: `Basic ${localStorage.getItem("token")}`,
